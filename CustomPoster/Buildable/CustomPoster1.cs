...
namespace CustomPoster
{
    ...
    public class CustomPoster1
    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster1");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster1", "CustomPoster1", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster1"), 2, 3);
